...
const T = {
  fr: {
    ...
    hero: {
      badge: "v3.0 · La suite numérique pour pros du chantier",
      title_a: "Des outils",
      title_b: "Conçus pour",
      title_c: "Le chantier",
      title_tail: "— spécialisés, précis, québécois.",
      subtitle:
        "SeriesPro360 est une suite d'applications numériques conçues spécifiquement pour les professionnels québécois de la construction. Chaque app est dédiée à un métier précis : tôlerie, calcul de matériaux, estimation et devis.",
      cta_primary: "Découvrir les apps",
      cta_secondary: "",
      meta_1: "Applications spécialisées par métier",
      meta_2: "Conçu pour le marché québécois",
  ...
  en: {
    ...
    hero: {
      ...
      title_b: "Compute",
      title_c: "Deliver",
      title_tail: "— specialized, precise, Quebec-built.",
      subtitle:
        "SeriesPro360 is a suite of digital applications built specifically for Quebec construction professionals. Each app is dedicated to a specific trade: sheet metal, material calculation, estimating and quotes.",
      cta_primary: "Discover the apps",
      cta_secondary: "",
      meta_1: "Specialized apps by trade",
      meta_2: "Built for the Quebec market",
