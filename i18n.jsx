...
const T = {
  fr: {
    ...
    origin: {
      ...
      story2: "TrimPro360 n'est pas né d'une idée de startup. Il est né d'un besoin réel, dans une vraie entreprise. J'ai d'abord développé TrimPro360 pour mon employeur de l'époque — un atelier de fabrication de profilés de revêtement extérieur. L'outil a été utilisé en production réelle avant même d'être offert sur le marché.",
  ...
  en: {
    ...
    origin: {
      ...
      story2: "TrimPro360 wasn't born from a startup idea. It was born from a real need, in a real company. I first developed TrimPro360 for my employer at the time — a shop fabricating exterior cladding profiles. The tool was used in real production before it was ever brought to market.",
