...
const T = {
  fr: {
    ...
    hero: {
      ...
      subtitle: "SeriesPro360 développe des applications spécialisées pour les entrepreneurs et techniciens de la construction au Québec. Chaque outil est réfléchi en fonction de votre métier.",
    ...
    origin: {
      ...
      headline: "Né d'un vrai besoin. Testé en production réelle.",
      founder_title: "Histoire du fondateur",
      story: "Je m'appelle Yan Levasseur. Je viens du Centre-du-Québec et j'ai passé 7 ans dans le revêtement extérieur — dessinateur, chargé de projet, opérateur, programmeur de plieuses. Je connais le métier de l'intérieur.",
      story2: "SeriesPro360 est né de la conception de TrimPro360 — développé pour un vrai atelier de fabrication de profilés de revêtement extérieur, utilisé en production réelle avant même d'être offert sur le marché. Pas une idée de startup : un outil né d'un besoin concret, dans une vraie entreprise.",
      story3: "Je ne suis pas développeur. Je suis un architecte de solutions métier qui transforme l'expérience terrain en outils simples et efficaces. Si TrimPro360 résout de vrais problèmes, c'est parce qu'il a d'abord résolu les miens.",
      platform_title: "SeriesPro360",
      platform_desc: "SeriesPro360 est une plateforme regroupant plusieurs ERP verticaux spécialisés pour différents métiers de la construction.",
      logo_meaning: "Notre philosophie : Le logiciel s'adapte au métier. Pas l'inverse. Notre vision : créer des applications spécialisées, simples et connectées — plutôt qu'un ERP géant complexe à implanter.",
      positioning: [
    ...
    trust: {
      ...
      stats: [
        { value: "< 2 min", label: "De la soumission à la production" },
        { value: "2 apps", label: "Applications métier intelligentes" },
        { value: "14 jours", label: "Version d’essai gratuite, sans carte" },
      ...
      products: [
        {
          ...
          modal: {
            ...
            pricing: {
              ...
              plans: [
                {
                  ...
                  price: "149$",
                  cadence: "/ mois à vie",
                  desc: "Limité aux 10 premières entreprises.",
                  spotsLeft: 10,
                  spotsLeftText: "places restantes",
                  features: [
                ...
                },
                {
                  ...
                  price: "299$",
                  cadence: "/ mois",
                  desc: "Après la période de lancement.",
                  features: [
                    "Toutes les fonctionnalités",
                    "Mises à jour incluses",
                    "Support inclus",
                ...
                },
                {
                  ...
                  price: "Sur mesure",
                  cadence: "",
                  desc: "Contactez-nous pour une solution entreprise.",
                  features: [
                    "Intégrations ERP personnalisées",
                    "Branding sur mesure",
                    "Formations dédiées",
                    "SLA garanti",
                  ],
              ...
              faq: [
                { q: "Qu'est-ce que l'Offre Fondateur ?", a: "Un tarif préférentiel de 149$/mois à vie, réservé aux 10 premières entreprises qui nous font confiance. Ce tarif ne changera jamais, même après le lancement officiel." },
                { q: "Quand bascule-t-on au Tarif Régulier ?", a: "Une fois les 10 places Fondateur attribuées, ou après la période de lancement officielle. Le tarif régulier est de 299$/mois." },
                { q: "Y a-t-il des frais d'implantation ?", a: "Non. Ni frais d'implantation, ni frais de mise en route. Vous démarrez immédiatement." },
                { q: "Puis-je changer d'offre ?", a: "Oui. Vous pouvez passer du Tarif Régulier à l'offre Entreprise à tout moment. Les clients Fondateurs conservent leur tarif à vie." },
              ],
            },
            modules: [
        ...
        },
        {
          ...
          desc: "Plateforme SaaS complète pour la fabrication, la commande et le suivi des panneaux d'acier, d'aluminium et d'ACM. Conçu par et pour les ateliers de tôle québécois.",
          color: "green",
          cta: "Être notifié",
          url: "#",
          placeholder: true,
          modal: {
            headline: "Panneaux métalliques. De la commande à la production.",
            about: "PanelPro360 centralise la fabrication, la commande et le suivi des panneaux d'acier, d'aluminium et d'ACM. Conçu pour les ateliers québécois qui veulent gérer leur production de panneaux dans un seul flux — sans Excel, sans courriels perdus.",
            features: [],
            steps: [],
    ...
    why_specialized: {
      ...
      points: [
        { icon: "cpu", title: "Conçu pour ton métier", desc: "TrimPro360 connaît les profilés métalliques. CalcuPro360 connaît les normes CNB. Pas besoin de configurer — c'est déjà là." },
        { icon: "zap", title: "Opérationnel en minutes", desc: "Aucune formation, aucun consultant, aucun frais d'implantation. Tu ouvres l'app et tu travailles immédiatement." },
        { icon: "globe", title: "Terrain et bureau connectés", desc: "Chargé de projet, atelier, client — tout le monde travaille sur la même information, en temps réel." },
        { icon: "shield", title: "Une suite qui grandit avec toi", desc: "Tu démarres avec une app. Tu en ajoutes une autre quand tu en as besoin. Chaque outil s'intègre à la plateforme." },
      ],
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: "SeriesPro360 builds specialized apps for Quebec construction contractors and technicians. Each tool is built around your trade.",
    ...
    origin: {
      ...
      headline: "Born from a real need. Tested in real production.",
      founder_title: "The founder's story",
      story: "My name is Yan Levasseur. I'm from Centre-du-Québec and spent 7 years in exterior cladding — drafter, project manager, operator, and brake press programmer. I know the trade from the inside.",
      story2: "SeriesPro360 was born from building TrimPro360 — developed for a real exterior cladding fabrication shop, used in actual production before it was ever brought to market. Not a startup idea: a tool born from a concrete need, inside a real company.",
      story3: "I'm not a developer. I'm a business solutions architect who turns field experience into simple, effective tools. If TrimPro360 solves real problems, it's because it first solved mine.",
      platform_title: "SeriesPro360",
      platform_desc: "SeriesPro360 is a platform grouping several specialized vertical ERPs for different construction trades.",
      logo_meaning: "Our philosophy: the software adapts to the trade. Not the other way around. Our vision: build specialized, simple, connected apps — instead of one giant ERP that takes months to implement.",
      positioning: [
    ...
    trust: {
      ...
      stats: [
        { value: "< 2 min", label: "From submission to production" },
        { value: "2 apps", label: "Intelligent trade-specific apps" },
    ...
    suite: {
      ...
      products: [
        ...
        },
        {
          ...
          desc: "Full SaaS platform for manufacturing, ordering and tracking steel, aluminum and ACM panels. Built by and for Quebec sheet metal shops.",
          color: "green",
          cta: "Get notified",
          url: "#",
          placeholder: true,
          modal: {
            headline: "Metal panels. From order to production.",
            about: "PanelPro360 centralizes the manufacturing, ordering and tracking of steel, aluminum and ACM panels. Built for Quebec shops that want to manage panel production in one flow — no Excel, no lost emails.",
            features: [],
            steps: [],
    ...
    why_specialized: {
      ...
      points: [
        { icon: "cpu", title: "Built for your trade", desc: "TrimPro360 knows metal cladding profiles. CalcuPro360 knows NBC standards. No setup needed — it's already there." },
        { icon: "zap", title: "Running in minutes", desc: "No training, no consultant, no implementation fees. Open the app and get to work immediately." },
        { icon: "globe", title: "Field and office connected", desc: "Project manager, shop, client — everyone works on the same information, in real time." },
        { icon: "shield", title: "A suite that grows with you", desc: "Start with one app. Add another when you need it. Every tool integrates into the platform." },
      ],
