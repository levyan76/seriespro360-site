...
const T = {
  fr: {
    ...
    hero: {
      ...
      title_b: "Produisez",
      title_c: "Livrez",
      title_tail: "— sans paperasse, sans erreur.",
      subtitle:
        "SeriesPro360 développe des outils numériques spécialisés pour les pros québécois de la construction. TrimPro360, notre logiciel de commande et production de moulures métalliques, est l'app phare de la suite. CalcuPro360 et d'autres outils complètent l'écosystème.",
      cta_primary: "Découvrir TrimPro360",
      cta_secondary: "Voir toutes les apps ↓",
      meta_1: "Logiciel SaaS pour ateliers de tôle",
      meta_2: "Commandes, production & suivi",
  ...
  en: {
    ...
    hero: {
      ...
      title_b: "Compute",
      title_c: "Deliver",
      title_tail: "— no paperwork, no errors.",
      subtitle:
        "SeriesPro360 builds specialized digital tools for Quebec construction pros. TrimPro360, our metal trim ordering and production software, is the flagship app of the suite. CalcuPro360 and other tools complete the ecosystem.",
      cta_primary: "Discover TrimPro360",
      cta_secondary: "See all apps ↓",
      meta_1: "SaaS software for sheet metal shops",
      meta_2: "Orders, production & tracking",
