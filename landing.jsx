...
function InteractiveLogo({ lang, height }) {
  ...
  return (
    <div style={{ position: "relative", display: "inline-block", lineHeight: 0 }}>
      ...
      />
      <p style={{ position: "absolute", bottom: "23%", left: "22%", fontSize: 12, color: "#94A3B8", margin: 0, textAlign: "center", letterSpacing: "0.02em", zIndex: 2, pointerEvents: "none", whiteSpace: "nowrap" }}>
